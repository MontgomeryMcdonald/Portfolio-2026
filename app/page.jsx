    ...
    <div className="flex flex-col align-center justify-center items-center w-full h-full">
      ...
      <div className="bg-[#083117] border-8 border-[#00ee00] m-[.5vh] p-4 text-lg w-screen lg:w-[25vw]">
        ...
        <ul className="p-2.5 m-2.5">
          ...
          <li className="list-disc text-lg">Computer Science (ITS Software Development)</li>
      ...
      <div className="bg-[#083117] border-8 border-[#00ee00] m-[.5vh] p-4 text-lg w-screen lg:w-[25vw]"><p>When it comes to design, I can hit almost any mark. This portfolio, for example, uses very few colors, and sharper corners. Compared to other projects, where i might have more modern designs, or even more maximalist designs, both utilizing different design ideas. My design philosophy is based around usability and aesthetics. You can read more about my philosophies of design in the about page, which goes in-depth on how i use web design as a vehicle for rhetoric and advertisement. </p> <br /> <p>Typically, that kind of rhetoric as a tool for advertisement can be lacking in websites- they&apos;ll state things matter-of-factly, or just show a catalogue of what you sell. Websites with a good, strong design, however-- Like the ones i make -- do more than just that. They serve to show, entertain, and convince. </p> <br /> <p>When done right, websites can be a artform in of themselves, one that, like other multi-media artforms, can be a effective tool in your business&apos;s arsenal for advertisement, customer retainment, education about a topic, a source of donations for non-profits, and more. Thats what I do. I make websites that sell, teach and help people.</p> </div>
      <div className="bg-[#083117] border-8 border-[#00ee00] m-[.5vh] p-4 text-lg w-screen lg:w-[25vw]"><p>In abstract, my process is rather simple, outlined below. For more information, there is a page dedicated to this.</p>
          <ul className="p-2.5 m-2.5">
            <li className="list-disc text-lg">Create design following client input</li>
            <li className="list-disc text-lg">refine design from client input</li>
            <li className="list-disc text-lg">create website itself, while returning to the design and getting client input frequently.</li>
            <li className="list-disc text-lg">Finish design, do a final pass-through of polishing the website</li>
            <li className="list-disc text-lg">Show design to client, make any last-minute changes</li>
            <li className="list-disc text-lg">Deploy Website</li>
            <li className="list-disc text-lg">Maintain Website</li>
          </ul>
      </div>
      </div>
    </div>
